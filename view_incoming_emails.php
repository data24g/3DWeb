...
echo "<h1>📧 Email Classification System</h1>";
echo "<p>Hệ thống phân loại email tự động với độ tin cậy</p>";
echo "</div>";

// Process emails if requested
if (isset($_GET['process']) && $_GET['process'] == '1') {
    $result = processAndClassifyEmails($conn);
    echo "<div class='controls'>";
    echo "<div class='status success'>";
    echo "✅ Đã xử lý và phân loại {$result['count']} email mới!";
    echo "</div>";
...
echo "<div class='stat-number'>$incomingCount</div>";
echo "<div class='stat-label'>Email gốc</div>";
echo "</div>";
echo "<div class='stat-card'>";
echo "<div class='stat-number'>$processedCount</div>";
echo "<div class='stat-label'>Đã xử lý</div>";
echo "</div>";
echo "<div class='stat-card'>";
echo "<div class='stat-number'>" . ($incomingCount - $processedCount) . "</div>";
...
echo "<a href='check_database.php' class='btn btn-info'>🔧 Kiểm tra Database</a>";
echo "<a href='email_dashboard.html' class='btn btn-success'>📊 Dashboard</a>";
echo "</div>";
echo "<div class='status success'>";
echo "✅ Sẵn sàng xử lý";
echo "</div>";
...
echo "<h2>📥 Email gốc (Incoming Emails)</h2>";
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    echo "📭 Không có dữ liệu trong bảng incoming_emails<br>";
    echo "Hãy chạy <a href='check_database.php'>check_database.php</a> để thêm dữ liệu test";
    echo "</div>";
}
echo "</div>";
...
echo "<div class='section'>";
echo "<h2>📋 Email đã xử lý (Processed Emails)</h2>";
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    echo "Click nút 'Xử lý và Phân loại Email' để bắt đầu";
    echo "</div>";
}
echo "</div>";
